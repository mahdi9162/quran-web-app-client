      ...
      <Container>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-xl text-sm md:text-lg leading-relaxed text-base-content/70">
                This application is designed to make spiritual reading more comfortable and personalized. Experience a distraction-free
                interface built for the modern digital age.
              </p>
            </div>
        ...
        <div className="mt-24 grid gap-6 md:grid-cols-3">
          {coreValues.map((item, idx) => (
            <div
              key={idx}
              className="rounded-3xl border border-base-300 bg-base-100 p-8 shadow-sm transition-all hover:border-primary/30 hover:shadow-md"
            >
        ...
        <div className="mt-24 rounded-[2.5rem] border border-base-300 bg-base-100/50 p-8 backdrop-blur-sm md:p-16">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="group rounded-2xl bg-base-200/50 p-6 border border-transparent transition-all hover:border-primary/20 hover:bg-base-100"
              >
                <h3 className="text-lg font-bold text-base-content transition-colors group-hover:text-primary">{feature.title}</h3>
                <p className="mt-2 text-sm md:leading-7 text-base-content/60">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* 4. Bottom CTA */}
        <div className="mt-24 relative overflow-hidden rounded-[3rem] bg-linear-to-br from-primary via-[#11847c] to-secondary p-10 text-center text-primary-content shadow-2xl shadow-primary/30 md:p-20 group">
          {/*  Overlay Effect */}
          ...
          <div className="relative z-10 space-y-6">
            <h2 className="text-3xl font-bold md:text-5xl tracking-tight leading-tight">
              Built to make Quran <br className="hidden md:block" /> reading simple
            </h2>
            <p className="mx-auto max-w-2xl text-base md:text-xl opacity-90 font-medium leading-relaxed">
              Focusing on readability and accessibility. Every detail is polished to ensure your reading experience remains smooth and
              intuitive.
            </p>
            <div className="pt-6">
              <Link
                href="/surahs"
                className="btn bg-white text-primary hover:bg-base-200 border-none btn-lg rounded-2xl px-12 font-bold transition-all shadow-xl hover:scale-105 hover:shadow-2xl"
              >
                Start Reading Now
              </Link>
            </div>
